  ...
  const handleAdminSignup = async (e: React.FormEvent) => {
    ...
    try {
      await signup({
        ...
        name: signupName,
        isAdmin: true, // This flow is only for admins
        companyName: signupCompanyName,
      });
     
      router.push('/dashboard');
      toast({ title: "Company Account Created", description: "Welcome to PayPulse! You can now add employees." });
    } catch (error: any) {
            ...
            <div className="w-full max-w-xl">
                ...
                <Tabs defaultValue="login" className="w-full">
                    ...
                    <TabsContent value="signup">
                        <form onSubmit={handleAdminSignup} className="space-y-6 pt-6">
                            <div className="text-center">
